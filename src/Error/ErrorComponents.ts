/** ********************************************************************
 *
 * @模块名称: ErrorComponents
 *
 * @模块用途: ErrorComponents
 *
 ...
 *
 ********************************************************************* */
export class ErrorComponents extends HTMLElement {
    shadow: any = null;
    ...
    addEvent() {
        if (this.bth) {
            this.bth.addEventListener('click', this.bthClick);
            this.beginTime();
        }
    }

    disconnectedCallback() {
        clearTimeout(this.beginTimeer);
        if (this.bth) {
            this.bth.removeEventListener('click', this.bthClick)
        }
    }

    // @ts-ignore
    get seconds(): any {
        return this.shadow.querySelector('#seconds');
    }

    secondsValue = 5;
    beginTimeer: any;
    beginTime = () => {
        this.beginTimeer = setTimeout(() => {
            if (this.secondsValue) {
                this.seconds.innerText = this.secondsValue;
                this.secondsValue--;
                this.beginTime();
            } else {
                clearTimeout(this.beginTimeer);
        ...
        <div class="col-md-6 align-self-center">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                    ...
                    <g id="planet" transform="matrix(0.9997,-0.0263,0.0263,0.9997,-2.6911,14.9699)"
                       style="transform-origin: 0px 0px;">
                        ...
                        <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                                cx="548.891" cy="62.319" r="13.074" transform="matrix(1,0,0,1,2.259,0)"
                                style="transform-origin: 0px 0px;"></circle>
                        <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10"
                                cx="591.743" cy="158.918" r="7.989" transform="matrix(1,0,0,1,-2.259,0)"
                                style="transform-origin: 0px 0px;"></circle>
    ...
    \t\t\tM483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
                    ...
                    <g id="stars">
                        <g id="starsBig">
                            <g transform="matrix(0.9966,-0.0829,0.0829,0.9966,-19.4591,43.8183)"
                               style="transform-origin: 0px 0px;">
                            ...
                            <g transform="matrix(0.9745,-0.2244,0.2244,0.9745,-50.3626,40.8518)"
                               style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g transform="matrix(0.94,-0.3412,0.3412,0.94,-29.7026,117.8308)"
                               style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g transform="matrix(0.9965,-0.0835,0.0835,0.9965,-40.5227,18.484)"
                               style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                        ...
                        <g id="starsSmall">
                            ...
                            <g transform="matrix(0.996,0,0,0.9962,0.9259,1.1217)" style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g transform="matrix(0.931,0,0,0.9314,16.8382,37.8479)" style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g transform="matrix(0.786,0,0,0.7866,39.8807,87.7387)" style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                            ...
                            <g transform="matrix(0.561,0,0,0.5618,210.8502,180.1644)"
                               style="transform-origin: 0px 0px;">
                                <line fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                        ...
                        <g id="circlesBig">
                            <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                    ...
                                    transform="matrix(1,0,0,1,0,-1.506)" style="transform-origin: 0px 0px;"></circle>
                            <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                        ...
                        <g id="circlesSmall">
                            <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651"
                                    transform="matrix(1,0,0,1,0,-3.012)" style="transform-origin: 0px 0px;"></circle>
                    ...
                    <g id="spaceman" clip-path="url(cordClip)"
                       transform="matrix(0.9999,0.0131,-0.0131,0.9999,2.8897,1.0832)"
                       style="transform-origin: 0px 0px;">
    ...
    \t\t\t\tM330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246"
                                  transform="matrix(0.9999,0.0131,-0.0131,0.9999,3.4544,-3.6467)"
...
if (!customElements.get('error-404')) {
    customElements.define('error-404', ErrorComponents);
}
